...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h3 class="page-header" style="margin: 0px;">Tambah Kegiatan <small></small></h3>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">Form Input Kegiatan</h4>
        </div>
        <div class="panel-body">
					...
					<form method="POST" class="form-horizontal" @if(Auth::user()->level=='Super Admin') action="{{route('masterkegiatan.store')}}" @endif>
						@csrf
					  ...
					  <div class="form-group">
					      ...
					      <div class="col-sm-8">
					      		<select name="idprgrm" class="form-control" id="sel">
					      			@foreach($prog as $p)
						      			<option value="{{$p->id}}">{{$p->nmprgrm}}</option>
					      			@endforeach
					      		</select>
					      </div>
					  </div>
					  ...
					  <div class="form-group">
					      ...
					      <div class="col-sm-2">
							    <input type="text" class="form-control" name="kdperspektif" placeholder="kode perspektif">
					      </div>
					  </div>
					  <div class="form-group">
					      <label class="control-label col-sm-3" for="kdunit">Level Kegiatan:</label>
					      <div class="col-sm-2">
							    <input type="text" class="form-control" name="levelkeg" placeholder="level kegiatan">
					      </div>
					  </div>
					  <div class="form-group">
