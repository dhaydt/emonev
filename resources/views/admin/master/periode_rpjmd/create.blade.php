...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h3 class="page-header" style="margin: 0px;">Tambah Periode RPJMD <small></small></h3>
<!-- end page-header -->
...
<div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
					...
					<form method="POST" class="form-horizontal" @if(Auth::user()->level=='Super Admin') action="{{route('periode_rpjmd.store')}}" @endif>
						@csrf
					  <div class="form-group">
					      <label class="control-label col-sm-4" for="kdunit">Tahun Awal:</label>
					      <div class="col-sm-1">
					        <input type="number" class="form-control" name="thn_awal" placeholder="Tahun Awal">
					      </div>
					  </div>
					  <div class="form-group">
					      <label class="control-label col-sm-4" for="kdunit">Tahun Akhir:</label>
					      <div class="col-sm-1">
							    <input type="number" class="form-control" name="thn_akhir" placeholder="Tahun Akhir">	
					      </div>
					  </div>
					  <div class="form-group">
