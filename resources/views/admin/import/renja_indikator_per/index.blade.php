...
<ol class="breadcrumb pull-right">
    <li><a href="#">Home</a></li>
    <li>Impor & Ekspor</li>
    <li class="active">Renja Indikator Perubahan (Output)</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
...
<div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-success btn-sm" href="{{  url('/import?tbl=renja_indikator_per&eksport=true') }}"><i class="fa fa-arrow-up"></i> Eksport Renja Indikator Perubahan</a>
				</div>
			  </div>
			  <hr/>
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-info btn-sm" href="{{  url('/import?tbl=renja_indikator_per&eksport=template') }}"><i class="fa fa-download"></i> Download Template Import Renja Indikator Perubahan</a>
				</div>
			  </div>
