...
<ol class="breadcrumb pull-right">
    <li><a href="#">Home</a></li>
    <li>Impor & Ekspor</li>
    <li class="active">Renja Perubahan</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
...
<div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-success btn-sm" href="{{  url('/import?tbl=renja_per&eksport=true') }}"><i class="fa fa-arrow-up"></i> Eksport renja Perubahan</a>
				</div>
			  </div>
			  <hr/>
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-info btn-sm" href="{{  url('/import?tbl=renja_per&eksport=template') }}"><i class="fa fa-download"></i> Download Template Import Renja Perubahan</a>
				</div>
			  </div>
