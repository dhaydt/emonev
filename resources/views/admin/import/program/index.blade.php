...
<div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-success btn-sm" href="{{  url('/import?tbl=program&eksport=true') }}"><i class="fa fa-arrow-up"></i> Eksport Master Program</a>
				</div>
			  </div>
			  <hr/>
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-info btn-sm" href="{{  url('/import?tbl=program&eksport=template') }}"><i class="fa fa-download"></i> Download Template Import Master Program</a>
				</div>
			  </div>
