...
<div class="row">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-success btn-sm" href="{{  url('/import?tbl=realisasi&eksport=true') }}"><i class="fa fa-arrow-up"></i> Eksport Realisasi Kegiatan</a><hr>
				  <a class="btn btn-warning btn-sm" href="{{  url('/sinkron_realisasi_perubahan') }}"><i class="fa fa-refresh"></i> Sinkronkan Realisasi Kegiatan Awal & Perubahan</a>
				</div>
			  </div>
			  <hr/>
			  <div class="row">
				<div class="col-sm-2">
				  <a class="btn btn-info btn-sm" href="{{  url('/import?tbl=realisasi&eksport=template') }}"><i class="fa fa-download"></i> Download Template Import Realisasi Kegiatan</a>
				</div>
			  </div>
