 ...
 <div class="col-lg-12">
    ...
    <table class="table table-bordered table-striped display pageResize" id="data-table" width="100%">
        ...
        <tr>
            ...
            <td style="background-color: #57FF00;"><b>{{$prog->master_program->urusan()->nm_unit}}</b></td>
            <td style="background-color: #57FF00;"></td>
            <td style="background-color: #57FF00;"></td>
            ...
            @foreach($prog->rkpd_prog($data_renja) as $pi)
                @php 
                    ...
                    //$tkrpjmd=($tahun_1)+($tahun_2)+($tahun_3)+($tahun_4)+($tahun_5)+($tahun_6);
                        ...
                        $p_t6="<input type='text' id='p_t6[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' value='$tkrpjmd' onkeyup='kprog({$no_pink})' >";
...
@foreach($rkpd_keg as $rkpdkeg)
    <tr>
        ...
        <td style="background-color: silver"><b>{{$rkpdkeg->master_kegiatan->nmkegunit}}</b></td>
    	            ...
    	            @foreach($rkpdkeg->rkpd_keg($data_renja) as $pi)
    	                @php 
    	                    ...
    	                    if($pi->realisasi_tkegiatan!=""){
    	                        ...
    	                        $k_t6="<input type='text' id='k_t6[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' value='$tkrpjmd' onkeyup='kkegiatan({$no_pinkegiatan}{$pi->id})' >";
    	                        $rkpdkeg_re="<input type='text' id='k_re[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' onkeyup='kkegiatan({$no_pinkegiatan}{$pi->id})' value='$pre' $renstra2_dis>";
    	                        $k_t7="<input type='text' id='k_t7[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' value='$v7k' hidden='hidden'>";

    	                        $k_t1="<input type='text' id='k_t1[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' onkeyup='kkegiatan({$no_pinkegiatan}{$pi->id})' value='{$pt1}' $t1_dis>";
    	                        $k_t2="<input type='text' id='k_t2[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' onkeyup='kkegiatan({$no_pinkegiatan}{$pi->id})' value='{$pt2}' $t2_dis>";
    	                        $k_t3="<input type='text' id='k_t3[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' onkeyup='kkegiatan({$no_pinkegiatan}{$pi->id})' value='{$pt3}' $t3_dis>";
    	                        $k_t4="<input type='text' id='k_t4[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' onkeyup='kkegiatan({$no_pinkegiatan}{$pi->id})' value='{$pt4}' $t4_dis>";

    	                        $k_12k="<input type='text' id='k_12k[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' disabled='disabled'>";
    	                        $k_13k="<input type='text' id='k_13k[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' disabled='disabled'>";
    	                        $k_14k="<input type='text' id='k_14k[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' disabled='disabled'>";
    	                        $k_15k="<input type='text' id='k_15k[]' style='width:50px;' class='angka_k' maxlength='18' placeholder='K' disabled='disabled'>";

    	                        $ket_kegiatan="<textarea id='ket_kegiatan[]' rows=3 placeholder='keterangan'>{$ketp}</textarea>";
    	                        $fpenghambat_kegiatan="<textarea id='fpenghambat_kegiatan[]' rows=3 placeholder='faktor penghambat'>{$fpenghambat_kegiatan}</textarea>";
    	                        $fpendorong_kegiatan="<textarea id='fpendorong_kegiatan[]' rows=3 placeholder='faktor pendorong'>{$fpendorong_kegiatan}</textarea>";
    ...
    <!-- Sub Kegiatan -->
        ...
        @foreach($rkpdkeg->rkpd_subkeg($data_renja) as $vr)
            ...
            <tr>
                <td>{{$novr++}} </td>
                <td>{{$vr->master_subkegiatan->nmsub_keg}} </td>
