...
<table width="100%">
	<tr><th colspan='29'><b>FORMULIR @if($jenis=="RKPD") E19 @else E.81 @endif</b></th></tr>
	@if($jenis=="RKPD")
	<tr><th colspan='29'><b>Evaluasi Terhadap Hasil RKPD</b></th></tr>
	<tr><th colspan='29'><b>Kota Bukittinggi</b></th></tr>
	@else	
	<tr><th colspan='29'><b>Evaluasi Hasil Terhadap Renja Perangkat Daerah Lingkup Kota Bukittinggi</b></th></tr>	
...
<table border='1' style="border-collapse: collapse;">
	...
	<tr>
	    ...
	    <th rowspan=2 colspan=2 align="center" style="vertical-align: top;">Target {{$nmj}} pada Tahun 2021-2026 (akhir periode {{$nmj}})</th>
	    ...
	    <th rowspan=2 colspan=2 align="center" style="vertical-align: top;">Realisasi Capaian Kinerja dan Anggaran {{$jns}} yang dievaluasi Tahun {{$periode}}</th>
	    ...
	    <th rowspan=2 align="center" style="vertical-align: top;">Lokasi/Ket</th>
	    <th rowspan=2 align="center" style="vertical-align: top;">Faktor Penghambat</th>
	    <th rowspan=2 align="center" style="vertical-align: top;">Faktor Pendorong</th>
	</tr>
	<tr>
	...
	<tr>
	    ...
	    <th colspan=2 align="center">(12) = 8+9+10+11</th>
	    <th colspan=2 align="center">(13) = 12/7 * 100%</th>
	    <th colspan=2 align="center">(14) = 6+12</th>
	    <th colspan=2 align="center">(15) = 14/5 * 100%</th>
	...
	<tr style="background-color: #57FF00;font-weight: bold;">
	    ...
	    <td></td>
	    <td align="right">{{number_format($opd_t1,0,',','.')}}</td>
	    <td></td>
	    <td align="right">{{number_format($opd_t2,0,',','.')}}</td>
	    <td></td>
	    <td align="right">{{number_format($opd_t3,0,',','.')}}</td>
	    <td></td>
	    <td align="right">{{number_format($opd_t4,0,',','.')}}</td>
	    <td></td>
   ...
   <!-- Urusan -->
	@foreach($du as $vd)
	    ...
	    <tr style="background-color: yellow;font-weight: bold;">
	        ...
	        <td></td>
	        <td align="right">{{number_format($t_urusan_t1,0,',','.')}}</td>
	        <td></td>
	        <td align="right">{{number_format($t_urusan_t2,0,',','.')}}</td>
	        <td></td>
	        <td align="right">{{number_format($t_urusan_t3,0,',','.')}}</td>
	        <td></td>
	        <td align="right">{{number_format($t_urusan_t4,0,',','.')}}</td>
	        <td></td>
    ...
    <tr style="background-color: #E8A600;font-weight: bold;">
        ...
        <td></td>
        <td align="right">{{number_format($b_urusan_t1,0,',','.')}}</td>
        <td></td>
        <td align="right">{{number_format($b_urusan_t2,0,',','.')}}</td>
        <td></td>
        <td align="right">{{number_format($b_urusan_t3,0,',','.')}}</td>
        <td></td>
        <td align="right">{{number_format($b_urusan_t4,0,',','.')}}</td>
        <td></td>
    ...
    <tr>
        ...
        @foreach($prog->rkpd_prog($data_renja) as $pi)
            ...
            @if($jml_ind_prog>1)
                ...
                <td align='center' style="background-color: #0CDDE8">@php echo $p_t1; @endphp</td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t1,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8">@php echo $p_t2; @endphp</td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t2,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8">@php echo $p_t3; @endphp</td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t3,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8">@php echo $p_t4; @endphp</td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t4,0,',','.')}}</td>
            ...
            @else
                ...
                <td align='center' style="background-color: #0CDDE8">@php echo $p_t7; @endphp</td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($pagu_prog,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8"><?php echo $p_t1; ?></td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t1,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8"><?php echo $p_t2; ?></td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t2,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8"><?php echo $p_t3; ?></td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t3,0,',','.')}}</td>
                <td align='center' style="background-color: #0CDDE8"><?php echo $p_t4; ?></td>
                <td align='right' style="background-color: #0CDDE8">{{number_format($prog_t4,0,',','.')}}</td>
        ...
        @foreach($rkpd_keg->where('idprog',$prog->idprog) as $rkpdkeg)
            <tr>
            	...
            	@php 
            	            ...
            	            @foreach($rkpdkeg->rkpd_keg($data_renja) as $pi)
            	                ...
            	                @if($jml_ind_kegiatan>1)
            	                    ...
            	                    <td align="center" style="background-color: silver">@php echo $k_t1; @endphp</td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t1,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver">@php echo $k_t2; @endphp</td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t2,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver">@php echo $k_t3; @endphp</td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t3,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver">@php echo $k_t4; @endphp</td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t4,0,',','.')}}</td>
            	                ...
            	                @else
            	                    ...
            	                    <td align="center" style="background-color: silver">@php echo $k_t7; @endphp</td>
            	                    <td align="right" style="background-color: silver">{{number_format($pagu_kegiatan,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver"><?php echo $k_t1; ?></td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t1,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver"><?php echo $k_t2; ?></td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t2,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver"><?php echo $k_t3; ?></td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t3,0,',','.')}}</td>
            	                    <td align="center" style="background-color: silver"><?php echo $k_t4; ?></td>
            	                    <td align="right" style="background-color: silver">{{number_format($keg_t4,0,',','.')}}</td>
                ...
                @foreach($rkpdkeg->rkpd_subkeg($data_renja) as $vr)
                    ...
                    <tr>
                        ...
                        @if($jml_ind_keg>1)
                            ...
                            <td align="center">{{$vik->kt1}}</td>
                            <td align="right">{{number_format($rpt1,0,',','.')}} </td>
                            ...
                            <td align="right">{{number_format($rpt2,0,',','.')}} </td>
                            ...
                            <td align="right">{{number_format($rpt3,0,',','.')}} </td>
                            ...
                            <td align="right">{{number_format($rpt4,0,',','.')}} </td>
                ...
                @endforeach
                	...
                	@endphp
                	<tr>
                		<td colspan="25">Rata-rata Capaian Kinerja (%)</td>
                	...
                	<tr>
                		<td colspan="25">Predikat Kinerja</td>
...
<table width="100%">
	<tr>
		<td width="50%" colspan="25"></td>
		<td width="25%" align="center">Disusun</td>
		<td width="25%" align="center">Dievaluasi</td>
	</tr>
	<tr>
		<td width="50%" colspan="25"></td>
		<td width="25%" align="center">....................., {{Date('d-m-Y')}}</td>
		<td width="25%" align="center">Bukittinggi, ..................</td>
	</tr>
	<tr>
		<td width="50%" colspan="25"></td>
		<td width="25%" align="center"><b>{{ucwords($opd->nm_instansi)}}</b></td>
	...
	<tr>
		<td width="50%" colspan="25"></td>
		<td width="25%" align="center"><br><br><br></td>
		<td width="25%" align="center"></td>
	</tr>
	<tr>
		<td width="50%" colspan="25"></td>
		<td width="25%" align="center">.................................</td>
		<td width="25%" align="center"><b><u>ROBBY NOVALDI, SE., M.Ec.Dev</u></b></td>
	</tr>
	<tr>
		<td width="50%" colspan="25"></td>
		<td width="25%" align="center"></td>
